...
export const sergio = {
    ...
    // bio: '❤ Web Developer - .',
    bio: 'Entusiasta de la tecnología y los animales, busco abrirme camino en el mundo del desarrollo web.',
    ...
    education: [
      {
        ...
        startDate: 'Jan 2014', 
        endDate: 'Dec 2020', 
        description: 'Para mi tesis utilicé redes neuronales recurrentes LSTM. Librerías para el manejo y muestra de datos ( Pandas, Numpy, Matplot ), el procesamiento de datos ( TensorFlow, Keras ), y mi favorita, T_tides la cual me entregaba el análisis armónico de la marea. Todo esto con objeto de obtener los futuros niveles de la marea, en base a los datos entregados por la Intergovernmental Oceanographic Commission - Sea Level Station Monitoring Facility '},
    ...
    certificate: [
      // 
      {
        ...
        date: 'Jan 2019', 
        description: 'Certificación obtenida en el curso de Ingeniería de Proyectos.'},
      // 
      {
    ...
    courses:[
      // 
      {
        ...
        duration: 16, 
        institution:  'Udemy', 
        description: 'Curso realizado para aprender los conceptos de WEBSOCKET y SOCKET.IO de manera más profunda, CRUD basado en sockets, así como la sincronización de mapas en tiempo real.' },
      // 
      {
        name: 'Master en Python 3.x. Aprende de cero a experto con Práctica.', 
        duration: 5, 
        institution:  'Udemy', 
        description: 'Curso realizado para fortalecer conceptos de errores y manejo de excepciones y revisión de buenas prácticas.' },
      // 
      {
